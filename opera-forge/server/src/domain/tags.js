...
const TAG_CATALOG = [
  {
    ...
    tags: [
      {
        name: 'planetName',
        example: 'W466875-2 "Kestrel\'s Rest"',
        description: "Display name of the mission/opera's planet.",
      },
      {
        name: 'planetIdentifier',
        example: 'W466875-2',
        description: 'System id + orbital position, no nickname.',
      },
      {
        name: 'planetNickname',
        example: "Kestrel's Rest",
        description: 'Generated nickname (only exists for populous, advanced planets).',
      },
      { name: 'climate', example: 'arid', description: "Planet template's climate descriptor." },
      {
        name: 'colonizationLevel',
        example: 'frontier outpost',
        description: "Planet template's settlement descriptor.",
      },
      {
        name: 'faction',
        example: 'the Void Brotherhood',
        description: 'Group in control of the planet.',
      },
      {
        name: 'distance',
        example: 'at the edge of the sector, several jump-days out',
        description: "Planet template's distance flavor phrase.",
      },
    ],
  },
  {
    ...
    tags: [
      {
        name: 'difficulty',
        example: 'STANDARD',
        description: 'ROUTINE / STANDARD / HARD / PERILOUS / EPIC.',
      },
      {
        name: 'missionType',
        example: 'ESCORT',
        description:
          'Mission type identifier (ESCORT, HEIST, SABOTAGE, RECON, DIPLOMACY, EXTRACTION_OP).',
      },
      { name: 'clientName', example: 'Kael Voss', description: 'Person who hired the crew.' },
      {
        name: 'targetName',
        example: 'Ambassador Tolven',
        description: 'Person the mission is centered on (escort/diplomacy/extraction).',
      },
      {
        name: 'targetCorpName',
        example: 'the Halden Consortium',
        description: 'Corporation targeted by a heist/sabotage.',
      },
      {
        name: 'enemyGroupName',
        example: 'the Red Dogs',
        description: 'Hostile group opposing the crew.',
      },
      {
        name: 'securityGroupName',
        example: 'the Wolves of Kethar',
        description: 'Security force guarding a heist target.',
      },
    ],
  },
]
